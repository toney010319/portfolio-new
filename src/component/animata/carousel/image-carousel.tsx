...
export default function ImageCarousel({ items: initialItems }: IImageCarouselProps) {
  ...
  return (
    <div className="carousel-container relative h-[500px] w-[800px] overflow-hidden rounded-2xl   bg-inherit p-2">
      ...
      <div
        onClick={handleNext}
        className="navigation-item-right absolute right-0 top-[50%] z-20 flex h-10 w-10 translate-y-[-50%] cursor-pointer items-center justify-center rounded-lg hover:bg-gray-200 hover:bg-opacity-20 bg-clip-padding backdrop-blur-sm backdrop-filter"
      >
