...
function Background() {
  ...
  return (
    <div
      ref={containerRef}
      className="-z-1 absolute inset-0 flex h-full w-full flex-row justify-between bg-gradient-to-r from-[#191919] to-[#1c3f54]"
    >
      <div
        style={{
          background: "radial-gradient(50% 50% at 50% 50%,#072a39 0%,rgb(7,42,57) 50%,rgba(7,42,57,0) 100%)",
        }}
...
export default function AnimatedBeam({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
